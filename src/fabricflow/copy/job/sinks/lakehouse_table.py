...
class LakehouseTableSink(BaseSink):
    ...
    Attributes:
        ...
        If you choose to pass the table name, schema, or action from a list, you can leave these blank, but ensure that the corresponding 'sink_table_name', 'sink_schema_name', and 'sink_table_action' keys are still present in the list of dictionaries used for pipeline parameters.
